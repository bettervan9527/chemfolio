...
export function PaperCard({ paper, index }: PaperCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="pl-5 p-6">
        <div className="flex items-start justify-between gap-4 mb-3">
          <h4 className="text-sm font-semibold text-[var(--color-text-primary)] leading-relaxed group-hover:text-[var(--color-accent-cyan)] transition-colors font-[family-name:var(--font-display)]">
            {paper.title}
          </h4>
          {paper.doi && (
            <a
              ...
              className="flex-shrink-0 p-1.5 rounded-lg bg-white/[0.03] text-[var(--color-text-muted)]
                hover:text-[var(--color-accent-cyan)] hover:bg-[var(--color-accent-cyan)]/10 transition-all"
            >
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span className="text-xs font-medium px-2 py-0.5 rounded bg-[var(--color-accent-cyan)]/10 text-[var(--color-accent-cyan)]">
            {paper.journal}
          </span>
          ...
          {reportPath ? (
            <a
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs rounded-lg ml-auto
                ...
                hover:bg-[var(--color-accent-green)]/20 transition-all"
            >
        ...
        {paper.abstract && (
          <p className="mt-3 text-xs text-[var(--color-text-muted)]/70 leading-relaxed line-clamp-2">
            {paper.abstract}
          </p>
        )}
      </div>
